<div>
    ...
    <div class="py-4 space-y-4">
        ...
        <div class="flex justify-between">
            <div class="w-2/4 flex space-x-4">
                <x-input.text wire:model="filters.name" placeholder="Search Category..." />
            </div>
        ...
        <div class="flex-col space-y-4">
            <x-table>
                <x-slot name="head">
                    ...
                    <x-table.heading sortable multi-column wire:click="sortBy('photo')" :direction="$sorts['photo'] ?? null">Photo</x-table.heading>
                ...
                <x-slot name="body">
                    ...
                    <x-table.row wire:loading.class.delay="opacity-50" wire:key="row-{{ $item->id }}">
                        ...
                        <x-table.cell>
                            <span class="text-cool-gray-900 font-medium">{{ $item->photo }}</span>
                        </x-table.cell>
    ...
    <form wire:submit.prevent="deleteSelected">
        <x-modal.confirmation wire:model.defer="showDeleteModal">
            <x-slot name="title">Delete Categories</x-slot>
    ...
    <form wire:submit.prevent="save">
        <x-modal.dialog wire:model.defer="showEditModal">
            ...
            <x-slot name="content">
                ...
                <x-input.group for="price" label="Photo" :error="$errors->first('editing.price')">
